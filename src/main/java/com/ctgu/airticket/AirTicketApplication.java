...
public class AirTicketApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("***Flight信息管理***");
        System.out.println("http://localhost:8181/flight/findAll/0/5");
        System.out.println("***Company信息管理***");
        System.out.println("http://localhost:8181/company/findAll/0/2");
